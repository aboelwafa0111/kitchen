$(document).ready(function () {      
    ...
    function init_template(){//Class is vital to run AJAX Pages 
        ...
        $('.deploy-navigation, .deploy-navigation-header').click(function(){     
            var menu_elements = $(".navigation a").length;
            var rotate_angle = 180 / (menu_elements-0.9999);
            
            $('.deploy-left').addClass('deploy-left-active');
            $('.deploy-right').addClass('deploy-right-active');
            
            $('.line-1').addClass('line-1-active');
            $('.line-2').addClass('line-2-active');
            $('.line-3').addClass('line-3-active');
            
            $('.deploy-navigation').hide(0);
            $('.delete-navigation').show();

            $('.navigation a').each(function(i){ 
                var row = $(this);
                setTimeout(function() {
                    row.css({
                        "transform": "rotate("+(rotate_angle*i)+"deg)"
                    });
                    row.removeClass('nav-original');
                    row.addClass('nfa');
                }, 30*i);
            });             
        });
        
        $('.delete-navigation').click(function(){
            var menu_elements = $(".navigation a").length;
            var rotate_angle = 0;
            ...
            $('.delete-navigation').hide();
            $('.deploy-navigation').show();
            $('.navigation a').removeClass('navigation-close');
            ...
            $('.navigation a').each(function(i){ 
                ...
                setTimeout(function() {
                    ...
                    row.addClass('nav-original');
                    row.removeClass('nfa');
                }, 30*i);
            });        
        });
        
        if($('.navigation').hasClass('navigation-right')){$('.footer').addClass('footer-bottom');};
        if($('.navigation').hasClass('navigation-left')){$('.footer').addClass('footer-bottom');};
        if($('.navigation').hasClass('navigation-top')){$('.footer').addClass('footer-bottom');};
        if($('.navigation').hasClass('navigation-full')){$('.footer').addClass('footer-bottom');};   
        if($('.navigation').hasClass('navigation-bottom')){$('.back-to-top-badge').addClass('back-to-top-bottom');};   
    ...
    $(function(){
      ...
      var options = {
        ...
        forms: 'contactForm',
        onStart: {
          duration:550, // Duration of our animation
