...
<div class="page-login content full-bottom">
   ...
   <a href="home.php" class="button button-green button-icon button-full half-top full-bottom"><i class="ion-log-in"></i>Login</a>
   <div class="decoration full-top"></div>
   <a href="Registration.php" class="button button-blue button-icon button-full half-top full-bottom"><i class="ion-person-add"></i>Create Account</a>
</div>
<!-- ==================================== -->
